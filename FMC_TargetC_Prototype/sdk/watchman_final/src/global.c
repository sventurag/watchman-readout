...
int init_global_var(void){
	...
	regptr_0 = (int *)XPAR_TARGETC_2ASICS_0_BASEADDR ; //XPAR_TARGETC_INTERFACE_IP_0_BASEADDR;
	regptr_1 =(int *)XPAR_TARGETC_2ASICS_0_BASEADDR ; //XPAR_TARGETC_INTERFACE_IP_1_BASEADDR;
