...
module base_zynq_xbar_3(aclk, aresetn, s_axis_tvalid, s_axis_tready, 
  ...
  m_axis_tdata, m_axis_tstrb, m_axis_tlast, m_axis_tdest, s_req_suppress, s_decode_err)
/* synthesis syn_black_box black_box_pad_pin="aclk,aresetn,s_axis_tvalid[1:0],s_axis_tready[1:0],s_axis_tdata[63:0],s_axis_tstrb[7:0],s_axis_tlast[1:0],s_axis_tdest[19:0],m_axis_tvalid[0:0],m_axis_tready[0:0],m_axis_tdata[31:0],m_axis_tstrb[3:0],m_axis_tlast[0:0],m_axis_tdest[9:0],s_req_suppress[1:0],s_decode_err[1:0]" */;
  input aclk;
  input aresetn;
