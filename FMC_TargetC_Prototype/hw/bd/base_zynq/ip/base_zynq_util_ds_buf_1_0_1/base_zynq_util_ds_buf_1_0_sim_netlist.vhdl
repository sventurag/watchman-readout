...
entity base_zynq_util_ds_buf_1_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of base_zynq_util_ds_buf_1_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of base_zynq_util_ds_buf_1_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of base_zynq_util_ds_buf_1_0_util_ds_buf : entity is "OBUFDS";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of base_zynq_util_ds_buf_1_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of base_zynq_util_ds_buf_1_0_util_ds_buf : entity is "5'b00000";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_zynq_util_ds_buf_1_0 is
  port (
    OBUF_IN : in STD_LOGIC_VECTOR ( 0 to 0 );
    OBUF_DS_P : out STD_LOGIC_VECTOR ( 0 to 0 );
    OBUF_DS_N : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of base_zynq_util_ds_buf_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_zynq_util_ds_buf_1_0 : entity is "base_zynq_util_ds_buf_1_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of base_zynq_util_ds_buf_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of base_zynq_util_ds_buf_1_0 : entity is "util_ds_buf,Vivado 2020.2";
end base_zynq_util_ds_buf_1_0;

architecture STRUCTURE of base_zynq_util_ds_buf_1_0 is
  ...
  attribute x_interface_parameter of OBUF_DS_N : signal is "XIL_INTERFACENAME OBUF_DS_N, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN base_zynq_util_ds_buf_1_0_OBUF_DS_N, INSERT_VIP 0";
  attribute x_interface_info of OBUF_DS_P : signal is "xilinx.com:signal:clock:1.0 OBUF_DS_P CLK";
  attribute x_interface_parameter of OBUF_DS_P : signal is "XIL_INTERFACENAME OBUF_DS_P, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN base_zynq_util_ds_buf_1_0_OBUF_DS_P, INSERT_VIP 0";
...
begin
U0: entity work.base_zynq_util_ds_buf_1_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
