...
module base_zynq_TARGETC_2ASICS_0_0(SW_nRST_A, RefCLK_i1, axi_aclk, axi_aresetn, 
  tcA_axi_awaddr, tcA_axi_awprot, tcA_axi_awvalid, tcA_axi_awready, tcA_axi_wdata, 
  tcA_axi_wstrb, tcA_axi_wvalid, tcA_axi_wready, tcA_axi_bresp, tcA_axi_bvalid, 
  tcA_axi_bready, tcA_axi_araddr, tcA_axi_arprot, tcA_axi_arvalid, tcA_axi_arready, 
  tcA_axi_rdata, tcA_axi_rresp, tcA_axi_rvalid, tcA_axi_rready, SIN, SCLK, PCLK_A, SHOUT_A, 
  HSCLK_P_A, HSCLK_N_A, WR_RS_S0_A, WR_RS_S1_A, WL_CLK_P, WL_CLK_N, WR_CS_S0_A, WR_CS_S1_A, 
  WR_CS_S2_A, WR_CS_S3_A, WR_CS_S4_A, WR_CS_S5_A, GCC_RESET_A, RDAD_CLK_A, RDAD_SIN_A, 
  RDAD_DIR_A, SAMPLESEL_ANY_A, DO_A, SS_INCR_A, DOE_A, DONE_A, SS_RESET_A, REGCLR_A, SS_LD_SIN_A, 
  SS_LD_DIR_A, RAMP_A, SSTIN, MONTIMING_P_A, MONTIMING_N_A, Cnt_AXIS_DATA_A, CNT_CLR_A, 
  TestStream_A, FIFOvalid_A, FIFOdata_A, StreamReady_A, TrigA_A, TrigB_A, TrigC_A, TrigD_A, 
  WS_masterctrl_in_A, WS_masterctrl_out_A, SSVALID_INTR_A, SW_nRST_B, tcB_axi_aclk, 
