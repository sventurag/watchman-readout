...
set_property PACKAGE_PIN B20 [get_ports B_TRIGA] # changed from W14 to B20
set_property PACKAGE_PIN C20 [get_ports B_TRIGB] # changed from U15 to C20
set_property PACKAGE_PIN G14 [get_ports B_TRIGC] # changed from R16 to G14 
set_property PACKAGE_PIN J15 [get_ports B_TRIGD] # changed from M18 to J15
...
set_property PACKAGE_PIN D18 [get_ports B_SS_LD_DIR] # changed from U17 to D18
set_property PACKAGE_PIN E18 [get_ports B_SS_LD_SIN] # changed from T16 to E18
set_property PACKAGE_PIN W15 [get_ports REGCLR]


set_property PACKAGE_PIN Y13 [get_ports B_DO_5] # change from W20 to Y13
set_property PACKAGE_PIN V5 [get_ports B_DO_8] # changed from Y19 to V5
set_property PACKAGE_PIN W6 [get_ports B_DO_7] # changed from Y18 to W6
set_property PACKAGE_PIN L20 [get_ports B_DO_1] # change from W16 to L20
set_property PACKAGE_PIN E17 [get_ports B_RAMP] # changed from V16 to E17
set_property PACKAGE_PIN E19 [get_ports B_SS_RESET] # changed from R17 to E19
set_property PACKAGE_PIN J16 [get_ports B_DO_10] # changed from R18 to J16 
set_property PACKAGE_PIN V6 [get_ports B_DO_6] # changed from T17 to V6
set_property PACKAGE_PIN L14 [get_ports B_DO_13] # changed from V18 to L14
set_property PACKAGE_PIN L15 [get_ports B_DO_12] # changed from V17 to L15
#set_property PACKAGE_PIN W19 [get_ports DOE]
set_property PACKAGE_PIN M14 [get_ports B_DO_2] # change from W18 to M14
set_property PACKAGE_PIN M15 [get_ports B_DO_3] # changed from P18 to M15
set_property PACKAGE_PIN L19 [get_ports B_DONE] # changed from N17 to L19
...
set_property PACKAGE_PIN K16 [get_ports B_DO_11] # changed from H16 to K16
set_property PACKAGE_PIN H18 [get_ports B_RDAD_CLK] #changed H18 from H18
set_property PACKAGE_PIN F19 [get_ports B_RDAD_SIN] #changed from J18 to F19
set_property PACKAGE_PIN G15 [get_ports B_DO_14] # changed from D18 to G15
#set_property PACKAGE_PIN E17 [get_ports BB1]
set_property PACKAGE_PIN V10 [get_ports B_SS_INCR] # changed from D20 to V10
set_property PACKAGE_PIN Y12 [get_ports B_DO_4] # changed from D19 to Y12
#set_property PACKAGE_PIN E19 [get_ports BB5]
set_property PACKAGE_PIN H15 [get_ports B_DO_15] # changed from E18 to H15
set_property PACKAGE_PIN H20 [get_ports B_DO_16] # changed from F17 to H20
set_property PACKAGE_PIN V11 [get_ports B_DO_9] # changed from F16 to V11
set_property PACKAGE_PIN K17 [get_ports B_WR_CS_S4] # changed from L20 to K17
set_property PACKAGE_PIN F20 [get_ports B_RDAD_DIR] #changed from L19 to F20
set_property PACKAGE_PIN J20 [get_ports B_SAMPLESEL_ANY] # changed from M17 to J20
set_property PACKAGE_PIN K19 [get_ports B_WR_CS_S2] # changed from J19 to K19
set_property PACKAGE_PIN J19 [get_ports B_WR_CS_S3] # changed from K19 to J19
set_property PACKAGE_PIN M19 [get_ports B_WR_CS_S0] # changed from  G18 to M19
set_property PACKAGE_PIN M20 [get_ports B_WR_CS_S1] # changed from G17 to M20
set_property PACKAGE_PIN J18 [get_ports B_GCC_RESET] # changed from F20 to J18
set_property PACKAGE_PIN K18 [get_ports B_WR_CS_S5] # changed from F19 to K18
set_property PACKAGE_PIN F16 [get_ports B_WR_RS_S0] # changed from H20 to F16
set_property PACKAGE_PIN F17 [get_ports B_WR_RS_S1] # changed from J20 to F17
set_property PACKAGE_PIN E9 [get_ports CS_Enable] 
set_property PACKAGE_PIN D9 [get_ports SDA] #changed from G15 to D9
set_property PACKAGE_PIN E8 [get_ports SDATA]
set_property PACKAGE_PIN E6 [get_ports SPI_SCLK]
set_property PACKAGE_PIN C6 [get_ports SCL] # changed from H15 to C6
set_property PACKAGE_PIN D19 [get_ports B_PCLK] #changed from N16 to D19
set_property PACKAGE_PIN D20 [get_ports B_SHOUT] #changed from N15 to D20
...
set_property PACKAGE_PIN M18 [get_ports SyncAck_N] # Inverted pins
set_property PACKAGE_PIN M17 [get_ports SyncAck_P] # Inverted pins
set_property PACKAGE_PIN L17 [get_ports SyncClk_N] # Inverted pins
set_property PACKAGE_PIN L16 [get_ports SyncClk_P] # Inverted pins
set_property PACKAGE_PIN H16 [get_ports SyncTrig_P]
set_property PACKAGE_PIN H17 [get_ports SyncTrig_N]
set_property PACKAGE_PIN G17 [get_ports Frame_clk_P]
set_property PACKAGE_PIN G18 [get_ports Frame_clk_N]
set_property PACKAGE_PIN G19 [get_ports CH2.outA_P]
set_property PACKAGE_PIN G20 [get_ports CH2.outA_N]
set_property PACKAGE_PIN H16 [get_ports CH2.outB_P]
set_property PACKAGE_PIN J14 [get_ports CH2.outB_N]
set_property PACKAGE_PIN N16 [get_ports Input_clk_N] # Inverted pins
set_property PACKAGE_PIN N15 [get_ports Input_clk_P] # Inverted pins
#set_property PACKAGE_PIN H16 [get_ports SyncTrig_P]
#set_property PACKAGE_PIN H17 [get_ports SyncTrig_N]
...
set_property PACKAGE_PIN B19 [get_ports B_HSCLK_P] #changed from K14 to B19
set_property PACKAGE_PIN A20 [get_ports B_HSCLK_N] #changed from J14 to to A20
