...
connect_debug_port u_ila_0/probe1 [get_nets [list base_zynq_i/TARGET_C_TopLevel_Sy_0/U0/TC_RDAD_WL_SS/GCC_RESET]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list base_zynq_i/TARGET_C_TopLevel_Sy_0/U0/TC_RDAD_WL_SS/HSCLK]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list base_zynq_i/TARGET_C_TopLevel_Sy_0/U0/TC_RDAD_WL_SS/RAMP]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list base_zynq_i/TARGET_C_TopLevel_Sy_0/U0/TC_RDAD_WL_SS/SS_INCR]]
create_debug_port u_ila_0 probe
